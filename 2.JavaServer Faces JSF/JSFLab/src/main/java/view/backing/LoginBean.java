...
public class LoginBean {
    ...
    private UIComponent messageText;
    ...
    public void showMessage() {
            FacesContext context = FacesContext.getCurrentInstance();
            FacesMessage facesMessage = new FacesMessage(context.getApplication().evaluateExpressionGet(context, "#{AppMessages['message.message1']}", String.class));
            context.addMessage(getMessageText().getClientId(), facesMessage);
            context.renderResponse();
     ...
     */
    public UIComponent getMessageText() {
        return messageText;
    }
     ...
     */
    public void setMessageText(UIComponent messageText) {
